...
class Rajaongkir extends CI_Controller {
	...
	private $api_key= '711faa8c91520da41a8178a904891a3f';
	...
	public function kota(){
		...
		if ($err) {
		  ...
		  foreach ($data_kota as $key => $value) {
		  	echo "<option value='". $value['city_name'] . '/' . $value['city_id'] . "' id_kota='" . $value['city_id'] . "'>" . $value['city_name'] . "</option>";
		  }
		}
	}
	...
	public function paket(){
		...
		$id_kota_asal= $this->m_admin->data_setting()->id_kota;
		...
		if ($err) {
		  ...
		  foreach ($data_paket as $key => $value) {
		  	echo "<option value='". $value['service'] . "' ongkir='". $value['cost'][0]['value'] . "' estimasi='". $value['cost'][0]['etd'] ." Hari'>" . $value['service'] . " | Rp. " . $value['cost'][0]['value'] . " | " . $value['cost'][0]['etd'] ." Hari</option>";
		  }
		}
	}
