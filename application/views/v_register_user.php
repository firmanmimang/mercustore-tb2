        ...
        <div class="card-body register-card-body">
          ...
          <div class="form-group">
            <div class="input-group">
              <input type="text" name="nama_user" class="form-control" placeholder="Nama" value="<?= set_value('nama_user') ?>">
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-6">
                <a href="<?= base_url('auth/login_user') ?>" class="btn btn-success btn-block">login</a>
              </div>
              <!-- /.col -->
              <div class="col-6">
