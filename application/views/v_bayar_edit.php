            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="card card-primary">
                  ...
                  <?php echo form_open_multipart('pesanan_saya/edit_bayar/'.$pesanan->no_order); ?>
                    <div class="card-body">
                      <div class="form-group">
                        <label>Atas Nama</label>
                        <input type="text" name="atas_nama" class="form-control" placeholder="Atas Nama" value="<?= $pesanan->atas_nama ?>">
                        <?= form_error('atas_nama', '<small class="text-danger pl-1">', '</small>'); ?>
                      </div>
                      <div class="form-group">
                        <label>Nama Bank</label>
                        <input type="text" name="nama_bank" class="form-control" placeholder="Nama Bank" value="<?= $pesanan->nama_bank ?>">
                        <?= form_error('nama_bank', '<small class="text-danger pl-1">', '</small>'); ?>
                      </div>
                      <div class="form-group">
                        <label>Nomor Rekening</label>
                        <input type="text" name="no_rek" class="form-control" placeholder="Nomor Rekening" value="<?= $pesanan->no_rek ?>">
                        <?= form_error('no_rek', '<small class="text-danger pl-1">', '</small>'); ?>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputFile">Ganti Bukti Bayar</label>
                    ...
                    <div class="col-sm-12">  
                      <div class="form-group">
                          <img src="<?= (empty($pesanan->bukti_bayar)) ? base_url('assets/gambar/nofoto.jpg') : base_url('assets/bukti_bayar/'. $pesanan->bukti_bayar) ?>" id="gambar_load" width="200px" class="rounded mx-auto d-block">
                      </div>
                    </div>
                    <!-- /.card-body -->
