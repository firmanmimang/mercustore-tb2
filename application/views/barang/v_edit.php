                ...
                //   <h5><i class="icon fas fa-exclamation-triangle"></i>', '</h5></div>');
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Berat</label>
                        <input type="number" min="0" class="form-control" placeholder="Berat Dalam Gram" name="berat" value="<?= $barang->berat; ?>">
                  ...
                  <div class="row">
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">	
	                  <div class="form-group">
	                      <img src="<?= base_url('assets/gambar/'.$barang->gambar); ?>" id="gambar_load" width="200px" class="rounded mx-auto d-block">
	                  </div>
	                 </div>
